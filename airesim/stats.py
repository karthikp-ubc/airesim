...
class StatsCollector:
    ...
    bad_servers_cured: int = 0      # successful repairs of a server that was bad (bad -> good)
    bad_server_repair_failures: int = 0  # failed repairs of a bad server (it stays bad)
